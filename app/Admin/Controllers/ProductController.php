...
class ProductController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('category.name', __('Category Name'));//一覧画面ではカテゴリーIDではなく、カテゴリー名を表示
    ...
    protected function form()
    {
        ...
        $form->select('category_id', __('Category Name'))->options(Category::all()->pluck('name', 'id'));//存在するカテゴリー名から選択。CRUD画面で商品画像の設定や表示を可能とする
