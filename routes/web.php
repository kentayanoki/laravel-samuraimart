...
Route::get('/',  [WebController::class, 'index'])->name('top');/**「買い物を続ける」ボタンをクリックするとトップページに移動 */
...
//Route::get('users/carts', 'index')->name('carts.index');を追加し、カートの中身を確認するページへのURLを設定し、CartControllerでグルーピングを実施
    Route::controller(CartController::class)->group(function () {
        Route::get('users/carts', 'index')->name('carts.index');
        Route::post('users/carts', 'store')->name('carts.store');//カートへの追加を実施
